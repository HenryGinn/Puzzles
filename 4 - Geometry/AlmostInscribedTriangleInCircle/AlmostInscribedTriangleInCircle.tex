...
\begin{center}
	\begin{tikzpicture}[scale=3]
		...
		\input{4 - Geometry/AlmostInscribedTriangleInCircle/Coordinates.tikz}
...
\begin{center}
	\begin{tikzpicture}[scale=3]
		...
		\node at (A) [above = 0.1 of A] {$A$};
		\node at (D) [below right = 0.1 of D] {$D$};
		\node at (O) [left = 0.2 of O] {$O$};
		\node at (F) [right = 0.2 of F] {$F$};
		\node at (b) [right = 0.2 of O] {$4.5$};
		...
		\pic[draw, angle radius=30, angle eccentricity=1.3, "$60\degree$"] {angle = F--O--A};
